        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                // Compute tax for Married or qualifying widow(er) filers
               if (income <= 19050){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
                 ...
                 taxRate = 32;
                  ...
                  tax = 19050 * 0.10 + (44700 - 19050) * 0.12 +
                        (165000 - 77400) * 0.22 + (315000 - 165000) * 0.24 +
          ...
          *******************************************************************************/
               ...
               if (income <= 13600){
                 ...
                 taxRate = 32;
                  ...
                  tax = 13900 * 0.10 + (51800 - 13600) * 0.12 +
                        (82500 - 51800) * 0.22 + (157500 - 82500) * 0.24 +
                        (200000 - 157500) * 0.32 + (income - 200000) * 0.35;
                  taxRate = 35;
               }//end of else if
...
function clearButton () {
             ...
             //INSERT YOUR CODE BELOW
            document.getElementById("calculationinfo").value = "";
